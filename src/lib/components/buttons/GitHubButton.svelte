<script lang="ts">
	...
	import GitHubBlack from '$lib/assets/icons/GitHub_Invertocat_Black.svg';
</script>

{#if mode.current == 'dark'}
	<Button variant="ghost" size="icon" href="https://github.com/bunchofcellulose/aoXiv" target="_blank"
